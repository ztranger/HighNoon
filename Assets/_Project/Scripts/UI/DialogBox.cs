...
namespace HighNoon
{
    ...
    public class DialogBox : MonoBehaviour
    {
        ...
        public void Setup()
        {
            ...
            gameObject.GetComponent<Canvas>().sortingOrder = 100; // above the HUD

            // Panel (bottom).
            var panel = NewRect("Panel", transform, new Vector2(0.5f, 0f), new Vector2(0.5f, 0f));
            panel.pivot = new Vector2(0.5f, 0f);
            panel.sizeDelta = new Vector2(1600, 280);
            ...
            frame.sizeDelta = new Vector2(180, 220);
            ...
            portRt.sizeDelta = new Vector2(150, 190);
            _portrait = portRt.gameObject.AddComponent<Image>();
            _portrait.preserveAspect = true;

            // Speaker name.
            _name = MakeText(panel, "Name", 42, new Vector2(0f, 1f), new Vector2(230, -16), 1200, 56, TextAnchor.UpperLeft);
            _name.fontStyle = FontStyle.Bold;

            // Body line.
            _body = MakeText(panel, "Body", 36, new Vector2(0f, 1f), new Vector2(230, -78), 1280, 160, TextAnchor.UpperLeft);
